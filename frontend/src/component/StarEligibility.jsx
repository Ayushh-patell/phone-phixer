...
import { FiStar, FiArrowRight, FiAlertTriangle, FiGitBranch, FiCheckCircle } from "react-icons/fi";
...
const StarEligibilitySection = () => {
  ...
  const starLevels = Array.isArray(starLevelsSetting?.value) ? starLevelsSetting.value : [];
  const eligibilityRules = Array.isArray(eligibilitySetting?.value) ? eligibilitySetting.value : [];
    ...
    return (
      <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
        ...
        <div className="mt-3 text-xs text-neutral-600">
          {criteria.isOr
            ? "Meet any one of the items below."
            : "Meet all of the items below."}
        </div>
        ...
        <div className="overflow-hidden rounded-2xl border border-neutral-200 bg-white shadow-sm">
          ...
          <div className="p-4 md:p-5">
            ...
            <div className="mt-1 text-sm text-neutral-600">
              {nextLevelRules
                ? "Below are the current requirement sets."
                : "No requirements have been set for your next level yet."}
            </div>
            ...
            {nextLevelRules?.criterias && Array.isArray(nextLevelRules.criterias) ? (
              ...
              <div className="mt-4 text-sm text-neutral-600">{nextLevelRules ? "Rules format is missing/invalid." : "—"}</div>
            )}
          </div>
        </div>
      )}
